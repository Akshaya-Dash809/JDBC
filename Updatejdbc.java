...
public class Updatejdbc {
	public static void main(String[] args) {
		try {
			...
			Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/akshaya_db", "Akshaya","Ak@80933");
			//create statement step no 3
			Statement stmt = conn.createStatement();
			stmt.executeUpdate("Update emp1 set name='Sourav'  where id=2"); //update
			//delete record
